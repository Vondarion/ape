...
/**
 * The Class TestUserPlayerLuke.
 */
public class TestUserLuke extends TestUser {

	/** The Constant serialVersionUID. */
	private static final long		serialVersionUID			= -1118626156784482957L;

	/** The Constant log. */
	private static final Logger		log							= LoggerFactory.getLogger(TestUserLuke.class);

	// settings, careful when changing - can affect lots of test cases!
	/** The Constant USERNAME. */
	public static final String		USERNAME					= "Test-Luke";
	...
	public @interface ExecuteAsTestUserPlayerLuke {
	}
